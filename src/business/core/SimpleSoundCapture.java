...
public class SimpleSoundCapture extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9149036494234598179L;
    ...
    class Capture implements Runnable {
        ...
        public void run() {
            ...
            try {
            	pathfile = "recordVoice/output_"+System.currentTimeMillis()+".wav";
                AudioSystem.write(audioInputStream, AudioFileFormat.Type.WAVE, new File(pathfile));
            } catch (Exception ex) {
                ex.printStackTrace();
                return;
            }
